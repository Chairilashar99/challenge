...
router.post('/add', (req, res) => {
  pool.query(`INSERT INTO ch21 (id, strings, integers, floats, dates, boleans) VALUES ($${count2}, $${count2 + 1},$${count2 + 2},$${count2 + 3},$${count2 + 4},$${count2 + 5})`,
  [req.body.ids,
    req.body.Strings,
